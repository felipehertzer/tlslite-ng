...
class TestKeyExchangeBasics(TestKeyExchange):
    ...
    def test_makeClientKeyExchange(self):
        ...
        self.assertIsInstance(keyExchange.makeClientKeyExchange(), ClientKeyExchange)
    ...
    def test_signServerKeyExchange_with_sha1_in_TLS1_2(self):
        ...
        server_hello = ServerHello().create(
            (3, 3), bytearray(32), bytearray(0), cipher_suite
        )
        keyExchange = KeyExchange(
            cipher_suite, client_hello, server_hello, srv_private_key
        )

        server_key_exchange = ServerKeyExchange(cipher_suite, (3, 3)).createDH(5, 2, 3)
    ...
    def test_signServerKeyExchange_in_TLS1_1(self):
        ...
        cipher_suite = CipherSuite.TLS_DHE_RSA_WITH_AES_128_CBC_SHA
        server_hello = ServerHello().create(
            (3, 2), bytearray(32), bytearray(0), cipher_suite
        )
        keyExchange = KeyExchange(
            cipher_suite, client_hello, server_hello, srv_private_key
        )
        server_key_exchange = ServerKeyExchange(cipher_suite, (3, 2)).createDH(5, 2, 3)
    ...
    def test_signServerKeyExchange_with_sha256_dsa_in_TLS1_2(self):
        ...
        client_random = a2b_hex(
            "b9e296fd5e8fe94a4efeada64444583aee6716b2a69893" "8f6034be03ad4caac2"
        )
        server_random = a2b_hex(
            "96e132aa7ad29def997deb78dec61520c28d60e0c01b10" "4533267abb15f23b9a"
        )

        client_hello = ClientHello().create(
            (3, 3), bytearray(client_random), bytearray(0), cipher_suite
        )

        server_hello = ServerHello().create(
            (3, 3), bytearray(server_random), bytearray(0), cipher_suite
        )

        keyExchange = KeyExchange(
            cipher_suite, client_hello, server_hello, srv_private_key
        )
        server_key_exchange = ServerKeyExchange(cipher_suite, (3, 3)).createDH(
            59, 2, 14
        )
    ...
    def test_signServerKeyExchange_with_sha1_ecdsa_in_TLS1_2(self):
        ...
        server_key_exchange = ServerKeyExchange(cipher_suite, (3, 3)).createECDH(
            ECCurveType.named_curve, GroupName.secp256r1, bytearray(b"\x04\xff\xfa")
        )

        keyExchange.signServerKeyExchange(server_key_exchange, "sha1")

        self.maxDiff = None
        self.assertEqual(server_key_exchange.write(), self.expected_tls1_2_ecdsa_SKE)
    ...
    def test_signServerKeyExchange_in_TLS1_1_with_ecdsa(self):
        ...
        server_key_exchange = ServerKeyExchange(cipher_suite, (3, 2)).createECDH(
            ECCurveType.named_curve, GroupName.secp256r1, bytearray(b"\x04\xff\xfa")
        )
        ...
        self.maxDiff = None
        self.assertEqual(
            bytearray(server_key_exchange.write()), self.expected_tls1_1_ecdsa_SKE
        )
    ...
    def test_signServerKeyExchange_in_TLS1_1_signature_invalid(self):
        ...
        with self.assertRaises(TLSInternalError):
            keyExchange.privateKey.sign = mock.Mock(return_value=bytearray(b"wrong"))
            keyExchange.signServerKeyExchange(server_key_exchange)
...
class TestKeyExchangeVerifyServerKeyExchange(TestKeyExchange):
    def setUp(self):
        ...
        self.server_key_exchange = ServerKeyExchange(self.cipher_suite, (3, 3)).parse(
            Parser(self.expected_sha1_SKE[1:])
        )
        self.ske_tls1_1 = ServerKeyExchange(self.cipher_suite, (3, 2)).parse(
            Parser(self.expected_tls1_1_SKE[1:])
        )
...
class TestServerKeyExchangeDSA(unittest.TestCase):
    ...
    def test_verify_dsa_signature_in_TLS1_SHA1(self):
        ...
        ske = ServerKeyExchange(CipherSuite.TLS_DHE_DSS_WITH_AES_128_CBC_SHA, (3, 1))
        ske.parse(parser)
        client_random = a2b_hex(
            "3866b841a109ef41b69dc87e39972250c94d5a6f9f213d" "b501fdee8148abb56a"
        )
        server_random = a2b_hex(
            "c921b34964e0b13293ed8c4c1b102fc7c1b2ee21ca2726" "0b444f574e47524400"
        )

        KeyExchange.verifyServerKeyExchange(
            ske, self.x509.publicKey, client_random, server_random, None
        )
    ...
    def test_verify_dsa_signature_in_TLS1_2_SHA1(self):
        ...
        ske = ServerKeyExchange(CipherSuite.TLS_DHE_DSS_WITH_AES_128_CBC_SHA, (3, 3))
        ske.parse(parser)
        client_random = a2b_hex(
            "eddcc21c1c52aa53af5d428d73a8eb47182ccb04d4c3be" "4b3e4fc9079e9d6dd9"
        )
        server_random = a2b_hex(
            "a943c57c21dc242e67465f5c2b630952a7d83d137112a4" "621f61f668c29cd3bc"
        )
    ...
    def test_verify_dsa_signature_in_TLS1_2_SHA256(self):
        ...
        ske = ServerKeyExchange(CipherSuite.TLS_DHE_DSS_WITH_AES_128_GCM_SHA256, (3, 3))
        ske.parse(parser)
        client_random = a2b_hex(
            "93b4ce37563b8c4fba7aa594b242fa13c9c14cca3c6922" "c878f8e254ad453d5f"
        )
        server_random = a2b_hex(
            "2b27c3c3b5be6412e5434dceb76189ca9b17368c5d609e" "4c2e6e938af2b12609"
        )
...
class TestServerKeyExchangeP256(unittest.TestCase):
    ...
    def test_verify_ecdsa_signature_in_TLS1_2_SHA512(self):
        ...
        ske = ServerKeyExchange(
            CipherSuite.TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384, (3, 3)
        )
        ske.parse(parser)

        client_random = a2b_hex(
            "5078aff2993c6cc0d5bbc014a60e348890c" "ef321469d9f5ecc270be5e453e7c9"
        )
        server_random = a2b_hex(
            "aa14012f6c6070b585fa53ba1010d5c4c08" "7314bd272cd52734c44c8f6037679"
        )
    ...
    def test_verify_ecdsa_signature_in_TLS1_2_SHA1(self):
        ...
        client_random = a2b_hex(
            "affab7761c9d4882d10c17757f648" "76c04a25c0ccdbfa98d9c6a545794" "ab566c"
        )
        server_random = a2b_hex(
            "21b01edc3232325bc6d761e9d4fea" "ccd811051c5bc5f3e09d769a5e15d" "d67273"
        )
    ...
    def test_verify_ecdsa_signature_in_TLS1_2_SHA256(self):
        ...
        client_random = a2b_hex(
            "cd10871a3d49e42ec2a9e6fc871d1049" "86f5b9c91f4d3f9d693290a611424d2f"
        )
        server_random = a2b_hex(
            "109f6344e1fad353b2767f63ea152474" "bb12d21f5bd903880a30bda436f31684"
        )
...
class TestServerKeyExchangeP384(unittest.TestCase):
    ...
    def test_verify_ecdsa_signature_in_TLS1_2_SHA512(self):
        ...
        client_random = a2b_hex(
            "872eca2bd39eaca9eedb31c285f5809b" "5fd5a51efd6d1dee4e1ce4f741920a36"
        )
        server_random = a2b_hex(
            "d85951258d55798f93619c38ac4fdd54" "153c5930cdf2cba6d555eec8d709e303"
        )
    ...
    def test_verify_ecdsa_signature_in_TLS1_2_SHA384(self):
        ...
        client_random = a2b_hex(
            "f706a53d88a5eb52d981c9943413b4f6" "73d7426dd4373fe517c1b881ab5713d2"
        )
        server_random = a2b_hex(
            "d35fab56329f6ff1ac36a6fc6b98a393" "e50bc4cd8b8bf3038f8b914f0c105cd2"
        )
    ...
    def test_verify_ecdsa_signature_in_TLS1_2_SHA256(self):
        ...
        client_random = a2b_hex(
            "2b1ffe918934adb2d66bb085bf56ba31" "0f6568732f81abc7f60c1bc43b2b8d15"
        )
        server_random = a2b_hex(
            "5141986a5d3b26cbc051d58c76074643" "c62d8ba9a0aa77bceaa8ecec59771bfe"
        )
...
class TestServerKeyExchangeP521(unittest.TestCase):
    ...
    def test_verify_ecdsa_signature_in_TLS1_2_SHA384(self):
        ...
        client_random = a2b_hex(
            "ccef6eefa66dda9e90c5e56dc3efa1ec" "259485ebcd2ec736ad2bcb3598ac3615"
        )
        server_random = a2b_hex(
            "739fd50e4ecbb177f882536a71828f8e" "bcbcf3a3217da24fa3eb6f7d7b009401"
        )
    ...
    def test_verify_ecdsa_signature_in_TLS1_2_SHA512(self):
        ...
        client_random = a2b_hex(
            "455c9402792ab4443cacc8f3bc2c9815" "7a3f3e1026a49e50fc04a9a3d2ba18d3"
        )
        server_random = a2b_hex(
            "ae2c2a0b6f65209c10a6766e8d230eb6" "465927ae363950430ec049d6e32cae24"
        )
...
class TestCalcVerifyBytes(unittest.TestCase):
    ...
    def test_with_TLS1_3(self):
        vrfy = KeyExchange.calcVerifyBytes(
            (3, 4),
        ...
        self.assertEqual(
            vrfy,
            bytearray(b"\xc5\x86\xeeO\xbe\xed\xc67g\xe0\xb5\xea(#O\xfd1\x85\xa1\xcd"),
        )
    ...
    def test_with_TLS1_1(self):
        vrfy = KeyExchange.calcVerifyBytes(
            (3, 2), self.handshake_hashes, None, None, None, None
        )
    ...
    def test_with_TLS1_3_unsupported_hash(self):
        ...
        self.assertEqual(
            vrfy, bytearray(b"\xcfY\xa7\x9b \xea\xae4\xdb\xad)\xaeC\xc6\x98\xfd")
        )
...
class TestMakeCertificateVerify(unittest.TestCase):
    ...
    def test_with_TLS1_2(self):
        ...
        self.assertEqual(
            certVerify.signatureAlgorithm, (HashAlgorithm.sha1, SignatureAlgorithm.rsa)
        )
        self.assertEqual(
    ...
    def test_with_TLS1_2_md5(self):
        ...
        self.assertEqual(certVerify.version, (3, 3))
        self.assertEqual(
            certVerify.signatureAlgorithm, (HashAlgorithm.md5, SignatureAlgorithm.rsa)
        )
        self.assertEqual(
            certVerify.signature,
            bytearray(
    ...
    def test_with_TLS1_2_rsa_pss_sha256(self):
        ...
        with mock.patch("tlslite.utils.rsakey.getRandomBytes", m):
            ...
            self.assertEqual(certVerify.version, (3, 3))
            self.assertEqual(
                certVerify.signatureAlgorithm, SignatureScheme.rsa_pss_sha256
            )
            self.assertEqual(
                certVerify.signature,
                bytearray(
    ...
    def test_with_TLS1_1(self):
        ...
        certificate_request.create([CertificateType.x509], [], None)
...
class TestRSAKeyExchange(unittest.TestCase):
    def setUp(self):
        ...
        self.client_hello = ClientHello().create(
            (3, 3), bytearray(32), bytearray(0), []
        )
        self.server_hello = ServerHello().create(
            (3, 2), bytearray(32), bytearray(0), self.cipher_suite
        )

        self.keyExchange = RSAKeyExchange(
            self.cipher_suite,
            self.client_hello,
            self.server_hello,
    ...
    def test_RSA_key_exchange(self):
        ...
        clientKeyExchange = ClientKeyExchange(self.cipher_suite, (3, 2))
        clientKeyExchange.createRSA(self.srv_pub_key.encrypt(premaster_secret))

        dec_premaster = self.keyExchange.processClientKeyExchange(clientKeyExchange)
    ...
    def test_RSA_key_exchange_with_client(self):
        ...
        client_keyExchange = RSAKeyExchange(
            self.cipher_suite, self.client_hello, self.server_hello, None
        )

        client_premaster = client_keyExchange.processServerKeyExchange(
            self.srv_pub_key, None
        )
        clientKeyExchange = client_keyExchange.makeClientKeyExchange()

        server_premaster = self.keyExchange.processClientKeyExchange(clientKeyExchange)
...
class TestDHE_RSAKeyExchange(unittest.TestCase):
    def setUp(self):
        ...
        self.server_hello = ServerHello().create(
            (3, 3), bytearray(32), bytearray(0), self.cipher_suite
        )

        self.keyExchange = DHE_RSAKeyExchange(
            self.cipher_suite,
            self.client_hello,
            self.server_hello,
            self.srv_private_key,
    ...
    def test_DHE_RSA_key_exchange(self):
        ...
        cln_Yc = powMod(srv_key_ex.dh_g, cln_X, srv_key_ex.dh_p)
        cln_secret = numberToByteArray(powMod(srv_key_ex.dh_Ys, cln_X, srv_key_ex.dh_p))
    ...
    def test_DHE_RSA_key_exchange_with_client(self):
        ...
        client_keyExchange = DHE_RSAKeyExchange(
            self.cipher_suite, self.client_hello, self.server_hello, None
        )
        client_premaster = client_keyExchange.processServerKeyExchange(None, srv_key_ex)
        clientKeyExchange = client_keyExchange.makeClientKeyExchange()
    ...
    def test_DHE_RSA_key_exchange_with_rfc7919_groups(self):
        suppGroupsExt = SupportedGroupsExtension().create(
            [GroupName.ffdhe3072, GroupName.ffdhe4096]
        )
    ...
    def test_DHE_RSA_key_exchange_with_ECC_groups(self):
        suppGroupsExt = SupportedGroupsExtension().create(
            [GroupName.secp256r1, GroupName.secp521r1, 650]
        )
        self.client_hello.extensions = [suppGroupsExt]
        self.keyExchange = DHE_RSAKeyExchange(
            self.cipher_suite,
    ...
    def test_DHE_RSA_key_exchange_with_invalid_client_key_share(self):
        clientKeyExchange = ClientKeyExchange(self.cipher_suite, (3, 3))
    ...
    def test_DHE_RSA_key_exchange_with_small_prime(self):
        ...
        srv_key_ex = ServerKeyExchange(
            self.cipher_suite, self.server_hello.server_version
        )
    ...
    def test_DHE_RSA_key_exchange_with_small_subgroup_shared_secret(self):
        ...
        order = [
            ...
            int(
                "1a3adf8d6a69682661ca6e590b447e66ebd1bbdeab5e6f3744f06f4"
...
class TestSRPKeyExchange(unittest.TestCase):
    def setUp(self):
        ...
        self.client_hello = ClientHello().create(
            (3, 3), bytearray(32), bytearray(0), [], srpUsername=bytearray(b"user")
        )
        self.server_hello = ServerHello().create(
            (3, 3), bytearray(32), bytearray(0), self.cipher_suite
        )
        ...
        self.keyExchange = SRPKeyExchange(
            self.cipher_suite,
            self.client_hello,
            self.server_hello,
            self.srv_private_key,
    ...
    def test_SRP_key_exchange(self):
        ...
        A = powMod(srv_key_ex.srp_g, a, srv_key_ex.srp_N)
        x = makeX(srv_key_ex.srp_s, bytearray(b"user"), bytearray(b"password"))
        v = powMod(srv_key_ex.srp_g, x, srv_key_ex.srp_N)
        u = makeU(srv_key_ex.srp_N, A, srv_key_ex.srp_B)

        k = makeK(srv_key_ex.srp_N, srv_key_ex.srp_g)
        S = powMod(
            (srv_key_ex.srp_B - (k * v)) % srv_key_ex.srp_N,
            a + (u * x),
            srv_key_ex.srp_N,
        )
    ...
    def test_SRP_key_exchange_with_client(self):
        ...
        client_keyExchange = SRPKeyExchange(
            self.cipher_suite,
            self.client_hello,
            self.server_hello,
            None,
...
class TestECDHE_RSAKeyExchange(unittest.TestCase):
    def setUp(self):
        ...
        self.client_hello = ClientHello().create(
            (3, 3), bytearray(32), bytearray(0), [], extensions=ext
        )
        self.server_hello = ServerHello().create(
            (3, 3), bytearray(32), bytearray(0), self.cipher_suite
        )

        self.keyExchange = ECDHE_RSAKeyExchange(
            self.cipher_suite,
            self.client_hello,
            self.server_hello,
            self.srv_private_key,
    ...
    def test_ECDHE_key_exchange(self):
        ...
        abstractPoint = ecdsa.ellipticcurve.AbstractPoint().from_bytes(
            curve.curve, srv_key_ex.ecdh_Ys
        )
        cln_Ys = ecdsa.ellipticcurve.Point(
            curve.curve, abstractPoint[0], abstractPoint[1]
        )
        ...
        cln_S = cln_Ys * cln_Xc
        cln_premaster = numberToByteArray(cln_S.x(), getPointByteSize(cln_S))
    ...
    def test_client_ECDHE_key_exchange(self):
        ...
        client_keyExchange = ECDHE_RSAKeyExchange(
            self.cipher_suite,
            self.client_hello,
            self.server_hello,
            None,
    ...
    def test_signServerKeyExchange_with_sha384_in_TLS1_2(self):
        ...
        with mock.patch("tlslite.utils.rsakey.getRandomBytes", m):
            ...
            self.assertEqual(
                ske.signature,
                bytearray(
                    b"QH\x02Xl2\xa37\xeeV\x9d\x84\x96E;_iJ"
...
class TestEdDSASignatures(unittest.TestCase):
    ...
    def setUp(self):
        self.server_key_exchange = ServerKeyExchange(self.cipher_suite, (3, 3)).parse(
            Parser(self.expected_ed25519_ske[1:])
        )
        self.client_hello = ClientHello()
    ...
    def test_create_tls1_2_eddsa_sig(self):
        ...
        key_exchange = KeyExchange(cipher_suite, client_hello, server_hello, self.key)

        server_key_exchange = ServerKeyExchange(cipher_suite, (3, 3)).createECDH(
            ECCurveType.named_curve, GroupName.x25519, bytearray(b"\x01" * 32)
        )

        key_exchange.signServerKeyExchange(server_key_exchange, "ed25519")

        self.assertEqual(server_key_exchange.write(), self.expected_ed25519_ske)
...
class TestFFDHKeyExchange(unittest.TestCase):
    ...
    def test_calc_public_value(self):
        ...
        self.assertEqual(public, bytearray(b"\x00" * 255 + b"\x04"))
    ...
    def test_calc_shared_secret(self):
        ...
        self.assertEqual(shared, bytearray(b"\x00" * 255 + b"\x10"))
