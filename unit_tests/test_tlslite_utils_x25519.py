...
class TestDecodeUCoordinate(unittest.TestCase):
    def test_x25519_decode(self):
        value = a2b_hex(
            "e6db6867583030db3594c1a424b15f7c7" "26624ec26b3353b10a903a6d0ab1c4c"
        )
        ...
        self.assertEqual(
            scalar,
            int(
                "344264340339195944511551077811888216513"
    ...
    def test_x448_decode(self):
        value = a2b_hex(
            "06fce640fa3487bfda5f6cf2d5263f8"
...
class TestDecodeScalar22519(unittest.TestCase):
    def test_x25519_decode_scalar(self):
        value = a2b_hex(
            "a546e36bf0527c9d3b16154b82465edd6" "2144c0ac1fc5a18506a2244ba449ac4"
        )
        ...
        self.assertEqual(
            scalar,
            int(
                "310298424921150409048955604518630896564"
...
class TestUncommonInputsX25519(unittest.TestCase):
    def test_all_zero_k(self):
        k = bytearray(32)
        u = a2b_hex(
            "e6db6867583030db3594c1a424b15f7" "c726624ec26b3353b10a903a6d0ab1c4c"
        )
        ...
        self.assertEqual(
            ret,
            a2b_hex(
                "030d7ba1a76719f96d5c39122f690e78" "56895ee9d24416279eb9182010287113"
            ),
        )

    def test_all_zero_u(self):
        k = a2b_hex(
            "a546e36bf0527c9d3b16154b82465ed" "d62144c0ac1fc5a18506a2244ba449ac4"
        )
        u = bytearray(32)
...
class TestUncommonInputsX448(unittest.TestCase):
    def test_all_zero_k(self):
        ...
        self.assertEqual(
            ret,
            a2b_hex(
                "f8d21fea4fe227fa556d27ec5317d839"
    ...
    def test_all_zero_u(self):
        k = a2b_hex(
            "3d262fddf9ec8e88495266fea19a34d"
...
class TestKnownAnswerTests(unittest.TestCase):
    ...
    def test_x25519_1(self):
        ...
        self.assertEqual(
            a2b_hex(
                "c3da55379de9c6908e94ea4df28d084f" "32eccf03491c71f754b4075577a28552"
            ),
            ret,
        )
    ...
    def test_x25519_2(self):
        k = a2b_hex(
            "4b66e9d4d1b4673c5ad22691957d6af" "5c11b6421e0ea01d42ca4169e7918ba0d"
        )
        u = a2b_hex(
            "e5210f12786811d3f4b7959d0538ae2" "c31dbe7106fc03c3efc4cd549c715a493"
        )
        ...
        self.assertEqual(
            ret,
            a2b_hex(
                "95cbde9476e8907d7aade45cb4b873f88" "b595a68799fa152e6f8f7647aac7957"
            ),
        )
    ...
    def test_x448_1(self):
        ...
        self.assertEqual(
            ret,
            a2b_hex(
                "ce3e4ff95a60dc6697da1db1d85e6afbd"
    ...
    def test_x448_2(self):
        ...
        self.assertEqual(
            ret,
            a2b_hex(
                "884a02576239ff7a2f2f63b2db6a9ff37"
    ...
    def test_x25519_one_iteration(self):
        k = a2b_hex(
            "0900000000000000000000000000000" "000000000000000000000000000000000"
        )
        u = bytearray(k)
        ...
        self.assertEqual(
            ret,
            a2b_hex(
                "422c8e7a6227d7bca1350b3e2bb7279f7" "897b87bb6854b783c60e80311ae3079"
            ),
        )
    ...
    def test_x25519_thousand_iterations(self):
        ...
        self.assertEqual(
            k,
            a2b_hex(
                "684cf59ba83309552800ef566f2f4d3c" "1c3887c49360e3875f2eb94d99532c51"
            ),
        )
    ...
    def test_x25519_million_iterations(self):
        ...
        self.assertEqual(
            k,
            a2b_hex(
                "7c3911e0ab2586fd864497297e575e6f3b" "c601c0883c30df5f4dd2d24f665424"
            ),
        )

    def test_x448_one_iteration(self):
        k = a2b_hex(
            "05000000000000000000000000000000000000000"
            "000000000000000"
        ...
        self.assertEqual(
            ret,
            a2b_hex(
                "3f482c8a9f19b01e6c46ee9711d9dc14fd"
    ...
    def test_x448_thousand_iterations(self):
        ...
        self.assertEqual(
            k,
            a2b_hex(
                "aa3b4749d55b9daf1e5b00288826c46727"
    ...
    def test_x448_million_iterations(self):
        ...
        self.assertEqual(
            k,
            a2b_hex(
                "077f453681caca3693198420bbe515cae"
    ...
    def test_x25519_ecdh_a_share(self):
        a_random = a2b_hex(
            "77076d0a7318a57d3c16c17251b26645df4" "c2f87ebc0992ab177fba51db92c2a"
        )
        ...
        self.assertEqual(
            a_public,
            a2b_hex(
                "8520f0098930a754748b7ddcb43ef75a0" "dbf3a0d26381af4eba4a98eaa9b4e6a"
            ),
        )

    def test_x25519_ecdh_b_share(self):
        b_random = a2b_hex(
            "5dab087e624a8a4b79e17f8b83800ee6" "6f3bb1292618b6fd1c2f8b27ff88e0eb"
        )
    ...
    def test_x25519_ecdh_shared(self):
        ...
        self.assertEqual(
            a_shared,
            a2b_hex(
                "4a5d9d5ba4ce2de1728e3bf480350f25" "e07e21c947d19e3376f09b3c1e161742"
            ),
        )
