...
class TestDSAKey(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.key = Python_DSAKey(
            p=69602034731989554929546346371414762967051205729581487767213360812510562307621,
    ...
    def test_sign_verify_malformed_signature_r(self):
        ...
        sig = (
            b"\x30\x2d\x02\x15\x00\x9f\x0b\x26\xa0\xbc\x40\xe4\x80\xae\x67\x1e\xab\x1c\x69"
    ...
    def test_sign_verify_malformed_signature_s(self):
        ...
        sig = (
            b"\x30\x2d\x02\x14\x1a\x6e\x40\x15\x68\xe5\xbd\x02\x65\xc2\x76\xf0\x97\x0a\xab"
    ...
    def test_sign_verify_malformed_signature_unrecognized(self):
        ...
        sig = (
            b"\x30\x30\x02\x14\x1a\x6e\x40\x15\x68\xe5\xbd\x02\x65\xc2\x76\xf0\x97\x0a\xab"
            b"\x4a\xb0\xb6\xc8\x43\x02\x15\x00\x9f\x0b\x26\xa0\xbc\x40\xe4\x80\xae\x67\x1e"
    ...
    def test_sign_and_verify_with_sha1(self):
        ...
        key = Python_DSAKey(
            ...
            q=bytesToNumber(a2b_hex("f85f0f83ac4df7ea0cdf8f469bfeeaea14156495")),
            g=bytesToNumber(
                a2b_hex(
    ...
    def test_sign_and_verify_with_sha224(self):
        ...
        key = Python_DSAKey(
            ...
            q=bytesToNumber(a2b_hex("bc550e965647fb3a20f245ec8475624abbb26edd")),
            g=bytesToNumber(
                a2b_hex(
    ...
    def test_sign_and_verify_with_sha254(self):
        ...
        key = Python_DSAKey(
            ...
            q=bytesToNumber(a2b_hex("95031b8aa71f29d525b773ef8b7c6701ad8a5d99")),
            g=bytesToNumber(
                a2b_hex(
    ...
    def test_sign_and_verify_with_sha384(self):
        ...
        r = bytesToNumber(
            a2b_hex(
                "7695698a14755db4206e850b4f5f19c540b07d07e08a" "ac591e20081646e6eedc"
            )
        )
        s = bytesToNumber(
            a2b_hex(
                "3dae01154ecff7b19007a953f185f0663ef7f2537f0b" "15e04fb343c961f36de2"
            )
        )
        sig = encode_sequence(encode_integer(r), encode_integer(s))
        # test
    ...
    def test_sign_and_verify_with_sha512(self):
        ...
        r = bytesToNumber(
            a2b_hex(
                "a40a6c905654c55fc58e99c7d1a3feea2c5be64823d4" "086ce811f334cfdc448d"
            )
        )
        s = bytesToNumber(
            a2b_hex(
                "6478050977ec585980454e0a2f26a03037b921ca588a" "78a4daff7e84d49a8a6c"
            )
        )
        sig = encode_sequence(encode_integer(r), encode_integer(s))
        # test
