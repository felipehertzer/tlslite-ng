...
class TestAESCCM(unittest.TestCase):
    ...
    def test_seal(self):
        ...
        self.assertEqual(
            bytearray(
                b"%}Q.\x99\xa3\r\xae\xcbMc\xf2\x16,^\xff"
    ...
    def test_seal_small_tag(self):
        ...
        self.assertEqual(
            bytearray(
                b"%}Q.\x99\xa3\r\xae\xcbMc\xf2\x16,^\xff" b"\x14\xb8-?\x7f\xac\x8bI"
            ),
            encData,
        )
    ...
    def test_seal_256_small_tag(self):
        ...
        self.assertEqual(
            bytearray(b"IN\x1c\x06\xb8\x0b9SD<\xf8RL" b"\xb4,=\xa2\x91\x84j1*\x0f\xeb"),
            encData,
        )
    ...
    def test_open(self):
        ...
        ciphertext = bytearray(
            b"%}Q.\x99\xa3\r\xae\xcbMc\xf2\x16,^\xff\xa0I"
    ...
    def test_open_small_tag(self):
        ...
        ciphertext = bytearray(
            b"%}Q.\x99\xa3\r\xae\xcbMc\xf2\x16,^\xff\x14" b"\xb8-?\x7f\xac\x8bI"
        )
    ...
    def test_open_256_small_tag(self):
        ...
        ciphertext = bytearray(
            b"IN\x1c\x06\xb8\x0b9SD<\xf8RL" b"\xb4,=\xa2\x91\x84j1*\x0f\xeb"
        )
        plaintext = aesCCM.open(nonce, ciphertext, bytearray(0))
    ...
    def test_seal_with_test_vector_2(self):
        ...
        self.assertEqual(
            bytearray(
                b"n\xc7_\xb2\xe2\xb4\x87F\x1e\xdd\xcb\xb8"
                b"\x97\x11\x92\xbaMO\xa3\xaf\x0b\xf6\xd3E"
                b"Aq0o\xfa\xdd\x9a\xfd"
            ),
            encData,
        )
    ...
    def test_seal_with_test_vector_3(self):
        key = bytearray(
            b"\xfe\xff\xe9\x92\x86\x65\x73\x1c" b"\x6d\x6a\x8f\x94\x67\x30\x83\x08"
        )
        aesCCM = AESCCM(key, "python", Rijndael(key, 16).encrypt)
        ...
        self.assertEqual(
            bytearray(
                b"\x08\x93\xe9K\x91H\x80\x1a\xf0\xf74&"
    ...
    def test_seal_with_test_vector_4(self):
        ...
        self.assertEqual(
            bytearray(
                b"\x08\x93\xe9K\x91H\x80\x1a\xf0\xf74&\xab"
    ...
    def test_seal_with_test_vector_5(self):
        ...
        self.assertEqual(
            bytearray(b"\xa8\x90&^C\xa2hU\xf2i" b"\xb9?\xf4\xdd\xde\xf6"), encData
        )
    ...
    def test_seal_with_test_vector_6(self):
        ...
        self.assertEqual(
            bytearray(
                b"\xc1\x94@D\xc8\xe7\xaa\x95\xd2\xde\x95"
                b"\x13\xc7\xf3\xdd\x8cK\n>^Q\xf1Q\xeb\x0f"
                b"\xfa\xe7\xc4=\x01\x0f\xdb"
            ),
            encData,
        )
...
class TestAESCCMIdentical(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.ciphertext = bytearray(
            b"\xbace\x8cG\x8c\x19i\xbc\x93C\xf2w\xd6?"
        ...
        self.ciphertext_8 = bytearray(
            b"\xbace\x8cG\x8c\x19i\xbc\x93C\xf2w"
