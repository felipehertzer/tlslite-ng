...
class TestAESCTR(unittest.TestCase):
    ...
    def test_encrypt_with_test_vector_1(self):
        key = bytearray(
            b"\x2b\x7e\x15\x16\x28\xae\xd2" b"\xa6\xab\xf7\x15\x88\x09\xcf\x4f\x3c"
        )
        ...
        counter = bytearray(
            b"\xf0\xf1\xf2\xf3\xf4\xf5\xf6\xf7\xf8" b"\xf9\xfa\xfb\xfc\xfd\xfe\xff"
        )
    ...
    def test_encrypt_with_test_vector_2(self):
        key = bytearray(
            b"\x8e\x73\xb0\xf7\xda\x0e\x64\x52\xc8"
        ...
        ciphertext = bytearray(
            b"\x1a\xbc\x93\x24\x17\x52\x1c\xa2"
    ...
    def test_encrypt_with_test_vector_3(self):
        key = bytearray(
            b"\x60\x3d\xeb\x10\x15\xca\x71\xbe"
        ...
        ciphertext = bytearray(
            b"\x60\x1e\xc3\x13\x77\x57\x89\xa5"
