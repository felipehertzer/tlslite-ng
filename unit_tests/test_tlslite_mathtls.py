...
class TestCalcFinishedInTLS1_0(TestCalcFinished):
    ...
    def test_client_value(self):
        ...
        self.assertEqual(
            bytearray(b"\xf8N\x8a\x8dx\xb8\xfe\x9e1\x0b\x8a#"), self.finished
        )
    ...
    def test_server_value(self):
        ...
        self.assertEqual(bytearray(b"kYB\xce \x7f\xbb\xee\xe5\xe7<\x9d"), ret_srv)
...
class TestCalcFinishedInTLS1_2WithSHA256(TestCalcFinished):
    ...
    def test_client_value(self):
        self.assertEqual(12, len(self.finished))
        self.assertEqual(bytearray(b"\x8e\x8c~\x03lU$S\x9fz\\\xcc"), self.finished)
...
class TestCalcFinishedInTLS1_2WithSHA384(TestCalcFinished):
    ...
    def test_client_value(self):
        self.assertEqual(12, len(self.finished))
        self.assertEqual(bytearray(b"UB\xeeq\x86\xa5\x88L \x04\x893"), self.finished)
    ...
    def test_server_value(self):
        ...
        self.assertEqual(bytearray(b"\x02St\x13\xa8\xe6\xb6\xa2\x1c4\xff\xc5"), ret_srv)
